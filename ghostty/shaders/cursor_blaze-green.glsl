...
// Purple blaze -- NORMAL speed (stock 0.5s).
#define TRAIL_LENGTH   1.5
#define TRAIL_DURATION 0.35
#define EASE_POWER     10.0
...
const vec4 TRAIL_COLOR = vec4(0.353, 0.949, 0.451, 1.0); // green
const vec4 CURRENT_CURSOR_COLOR = TRAIL_COLOR;
const vec4 PREVIOUS_CURSOR_COLOR = TRAIL_COLOR;
const vec4 TRAIL_COLOR_ACCENT = vec4(0.706, 1.000, 0.400, 1.0); // green accent
